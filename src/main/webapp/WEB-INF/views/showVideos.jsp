        ...
        <div class="col-md-12 column">
                ...
                <div id="options" class="collapse out">
                    <ul>
                        <li>
                            <div>
                                <span>时长:</span>
                                <input type="radio" checked="checked" class=" radiocheck" name="radio" value="0"
                                       id="radio"/>
                                <label class=" full small left" style="margin-left:10px!important;"
                                       for="radio">全部</label>
                        ...
                        <li>
                            <div>
                                <span>排序:</span>
                                <input type="radio" checked="checked" class=" radiocheck" name="radio_order" value="0"
                                       id="radio_order"/>
                        ...
                        <li class="option-btn">
                            <a href="javascript:void(0)" onclick="getResultVideos(true)"
                               class="button button-rounded button-tiny">筛选</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="tz-gallery">
                ...
                <div class="col-sm-12" style="text-align:center">
                    <a id="load-btn" href="javascript:void(0);" onclick="getResultVideos()"
